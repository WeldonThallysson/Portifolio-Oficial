    ...
    <section className="fundopreto">
      ...
      <div className="Conteiner__TituloPrincipal">
        ...
        <div className="Conteiner__Ensignias">
          <FaReact className="ensignias react" color="white" size={30} />
          <FaHtml5 className="ensignias html" color="white" size={30} />
          <FaCss3 className="ensignias css3" color="white" size={30} />
          <TbBrandJavascript
          ...
          <TbBrandReactNative
            ...
            size={30}
          />
          <FaGitAlt className="ensignias git" color="white" size={30} />
          <FaGithub className="ensignias github" color="white" size={30} />
        </div>
      </div>
    </section>
  );
